...
import bikash from '../../../assets/image/bikash.jpg';
...
import tahomin from '../../../assets/image/tahomin.jpg';
  ...
  return (
    <div className="boddy">
      <div className="container pr-16 pl-16 carousel">
        <h1 className="text-4xl text-center font-bold py-6"> Our Teachers</h1>
        <Slider {...settings}>
          {/* Ismic History */}
          ...
          <div className="card-wrapper">
            <div className="card">
              ...
              <ul className="social-icons">
                <li>
                  <a href="#">
                    <AiFillFacebook className="fab text-5xl sm:text-1xl" />
                  </a>
                </li>
                <li>
                  <a href="#">
